/*
	...
	Date:	2/12/2018
	Desc:	Authenticates a user using the SHA2 hashing algorithm
*/

package dynauthcore

// // AuthenticateSHA2 - to perform command line SHA2 hash authentication for testing
// func AuthenticateSHA2(locks string, otp string, userid string, iterations int) {
// 	// first prep auth for comparison
// 	toHash := locks + otp

// 	authenticated, err := compareAuthsSHA2(toHash, userid)
// 	if err != nil {
// 		log.Fatal(err)
// 	}
...
// // AuthenticateSHA2API - to perform authentication for the restful API
// func AuthenticateSHA2API(userid string, auth string) bool {
...
// func compareAuthsSHA2(toCompare string, userid string) (bool, error) {
